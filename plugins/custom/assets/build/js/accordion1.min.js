...
class AccordionHandler extends elementorModules.frontend.handlers.Base {
  ...
  handleClick1(event) {
    ...
    if (jQuery($content_ele1).css("max-height") == "0px") {
      jQuery($content_ele1).css("max-height", jQuery($content_ele1).prop("scrollHeight"));
    } else {
...
jQuery(window).on("elementor/frontend/init", () => {
  ...
  elementorFrontend.hooks.addAction("frontend/element_ready/accordion1.default", addHandler);
});
/******/ })()
;